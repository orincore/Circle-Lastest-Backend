-- Update find_nearby_users function to filter by verification status
-- Only show users who have completed both face verification and email verification
...
-- Add comment
COMMENT ON FUNCTION find_nearby_users IS 'Finds nearby users within specified radius. Only returns users who have completed both face verification and email verification.';
